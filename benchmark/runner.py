...
def notears_nonlinear_mcp_base(dataset):
    general_options = {"gamma": 0.4, "lambda1": 0.1}
    optimizer_options = {
        "lr": 0.01,
        "num_steps": 5000,
...
def dagma_nonlinear_mcp_base(dataset):
    general_options = {"gamma": 0.4, "lambda1": 0.1}
    optimizer_options = {
        "lr": 0.01,
        "num_steps": 5000,
...
def dagma_nonlinear_mcp_flex(dataset):
    d = dataset.shape[1]
    model = flex.MLPMCP(
        dims=[d, 10, 1], activation="sigmoid", bias=True, lmd=0.1, gamma=0.4
    )
...
benchmark_fns = {
    ...
    "NOTEARS-NONLINEAR-BASE": notears_nonlinear_mcp_base,
    "NOTEARS-NONLINEAR-FLEX": notears_nonlinear_mcp_flex,
    # "DAGMA-BASE": dagma_mcp_base,
    # "DAGMA-FLEX": dagma_mcp_flex,
    # "DAGMA-NONLINEAR-BASE": dagma_nonlinear_mcp_base,
    # "DAGMA-NONLINEAR-FLEX": dagma_nonlinear_mcp_flex,
}
...
run_benchmarks(
    ...
    benchmark_fns,
    10,
    "benchmark_notears_nonlinear_mcp_flex_vs_base_20_nodes.txt",
    metric=["cpdag_shd", cpdag_metric],
)
